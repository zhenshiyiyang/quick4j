...
<div align="center" id="searchPage">
    ...
    ${page.pageNow} 页</font> <a href="rest/meta/list?pageNow=1"
                                class='search_A'>首页</a>
    <c:choose>
        <c:when test="${page.pageNow - 1 > 0}">
            <a href="rest/meta/list?pageNow=${page.pageNow - 1}"
    ...
    <c:choose>
        <c:when test="${page.totalPageCountMeta==0}">
            <a href="rest/meta/list?pageNow=${page.pageNow}"
    ...
    <c:choose>
        ...
        <c:otherwise>
            <a href="rest/meta/list?pageNow=${page.totalPageCountMeta}"
               class='search_A'>尾页</a>
        </c:otherwise>
    </c:choose>
    <script>
...
<script type="text/javascript" src="app/js/unStruct/searchList.js"></script>
</body>
</html>